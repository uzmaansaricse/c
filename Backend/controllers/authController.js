...
// Get social login configuration for frontend
export const getSocialLoginConfig = async (req, res) => {
  try {
    const config = {
    ...
    console.error("Error getting social login config:", error);
    res.status(500).json({
      success: false,
      message: "Failed to get social login configuration"
    });
  }
};